...
unidades_uno_diez = datos_uno_diez["Paquete"].sum()  # Suma los valores de la columna "Paquete" filtrados anteriormente

# Filtrar los datos de los paquetes de 11 a 20
datos_once_veinte = df[
    df["Paquete"] >= 11]  # Filtra los datos del DataFrame donde el valor de "Paquete" es mayor o igual a 11
...
grafico_matplot_lineas = lineas1.plot(y='Temperatura_[ºC]',
